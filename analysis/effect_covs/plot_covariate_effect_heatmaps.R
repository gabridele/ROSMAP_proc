...
# ============================================================
# The upstream within- and between-network scripts may write to different
# output subdirectories, so search the configured output tree recursively.
csvs_long <- list.files(
  path = AP26_OUTPUT_DIR,
...
make_covariate_heatmaps <- function(
    ...
    fill_limits = NULL,
    save_plots = FALSE,
    output_dir = ap26_output_dir("heatmaps")
) {
...
ggsave(
  filename = ap26_output("heatmaps", "heatmap_grid_site_pre.pdf"),
