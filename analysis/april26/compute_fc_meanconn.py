...
ATLAS_PATH = Path(
    "/Users/ga0034de/github_dir/ROSMAP_proc/analysis/april26/atlas-4S456Parcels/atlas-4S456Parcels_dseg.tsv")
...
def compute_fc_matrix(timeseries: np.ndarray, timeseries_file: str | Path) -> np.ndarray:
    ...
    output_dir = Path("/Users/ga0034de/Desktop/timeseries_2306_xcpd400/fc_matrices_456")
...
def main() -> None:
    ...
    files = glob("/Users/ga0034de/Desktop/timeseries_2306_xcpd400/*.tsv")
