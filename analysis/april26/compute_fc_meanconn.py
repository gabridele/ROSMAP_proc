...
ATLAS_PATH = Path(
    "/Users/ga0034de/github_dir/ROSMAP_proc/analysis/gradients/atlas_data/lea_atlas-Schaefer400TianS2Cereb-space-MNI152NLin6Asym/atlas-Schaefer400TianS2Cereb_dseg.tsv"
)
...
def compute_fc_matrix(timeseries: np.ndarray, timeseries_file: str | Path) -> np.ndarray:
    ...
    output_dir = Path("/Users/ga0034de/Desktop/extracted_ts_customgroup/site_wise/FC/rirc/")
    output_dir.mkdir(parents=True, exist_ok=True)

    output_stem = "_".join(timeseries_file.name.split("_")[:2])
    output_file = output_dir / f"{output_stem}_rirc_fc_matrix.npy"
...
def main() -> None:
    ...
    files = glob("/Users/ga0034de/Desktop/extracted_ts_customgroup/site_wise/rirc/*.tsv")
    ...
    """
    fc_submatrices = glob("/Users/ga0034de/Desktop/extracted_ts_customgroup/site_wise/FC/rirc/*_rirc_fc_matrix.npy")
    avg_fc_matrix = average_corr_matrices_fisher_z(fc_submatrices)
    np.save("/Users/ga0034de/Desktop/extracted_ts_customgroup/site_wise/FC/rirc/avg_fc_matrix.npy", avg_fc_matrix)
