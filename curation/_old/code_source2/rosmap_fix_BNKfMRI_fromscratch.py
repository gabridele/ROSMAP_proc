...
def main():
    datadir = '/home/gabridele/backup/ROSMAP_proc/sourcedata/batch_2'
    tmpdir = '/home/gabridele/backup/ROSMAP_proc/sourcedata/batch_2/tmpdir'

    os.makedirs(tmpdir, exist_ok=True)

    fmri_files = os.path.join(os.getcwd(), 'sub*', '*', 'rfMRI.zip')
    ...
    for ii, fmri in enumerate(zip_files):
        ...
        bids_name = os.path.join(os.getcwd(), sub_id, directory_path, f"{sub_id}_ses-#_task-rest_acq-BNK20090211_EPI_bold.nii.gz")
