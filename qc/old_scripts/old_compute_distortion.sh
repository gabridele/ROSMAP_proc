...
## attempt at computing distortion ratio for each subject/session based on the anatomical and functional masks generated by fmriprep. The distortion ratio is defined as the volume of functional voxels outside the anatomical brain divided by the total volume of functional voxels.
## this hasn't been fully tested and validated 
